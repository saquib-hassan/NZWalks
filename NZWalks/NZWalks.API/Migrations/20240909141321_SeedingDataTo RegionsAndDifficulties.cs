...
{
    /// <inheritdoc />
    public partial class SeedingDataToRegionsAndDifficulties : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("42239bd9-c2f6-401c-8855-b62e1be64f68"), "Hard" },
                    { new Guid("7565b2bc-e2f9-4812-a9dc-8ff367820d58"), "Medium" },
                    { new Guid("a87e4c59-f395-4c65-a40a-7fea123374d0"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("42239bd9-c2f6-401c-8855-b62e1be64f68"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("7565b2bc-e2f9-4812-a9dc-8ff367820d58"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a87e4c59-f395-4c65-a40a-7fea123374d0"));
